...
assert.match(day, /caches\.match\('\.\/assets\/parole-giorno-v1\.json'\)/);
...
assert.match(sw, /endsWith\('\/assets\/giornale\/latest\.json'\)/);
assert.match(sw, /c\.match\('\.\/assets\/giornale\/latest\.json'\)/);
