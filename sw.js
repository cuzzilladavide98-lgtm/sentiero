const CACHE = 'sentiero-v60s-274-5-test';
...
const CORE_ASSETS = ['./', './index.html', './manifest.json', './sentiero-app.js?v=60.274.5-test'];
const ASSETS = [...CORE_ASSETS, './sentiero-sync.js?v=60.274.5-test', './sentiero-day.mjs?v=60.274.5-test', './vendor/qrcode.js', './vendor/jsQR.js',
